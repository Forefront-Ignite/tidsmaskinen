...
enum SettingsKey {
    ...
    /// Comma-joined `TimelineBlock.Track` raw values the user switched off in
    /// My day's Lanes menu. Every lane, foreground included, is on by default.
    static let timelineHiddenLanes = "timelineHiddenLanes"
}
